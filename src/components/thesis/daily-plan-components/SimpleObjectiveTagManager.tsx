...
interface SimpleObjectiveTagManagerProps {
  availableTags: Tag[];
  selectedTags: Tag[];
...
const SimpleObjectiveTagManager: FC<SimpleObjectiveTagManagerProps> = ({
  availableTags,
  selectedTags,
  onTagAdd,
  onTagRemove,
      ...
      <Popover open={popoverOpen} onOpenChange={setPopoverOpen}>
        <PopoverTrigger asChild>
          <Input
            ...
            disabled={disabled}
            aria-label="Ajouter un tag pour l'objectif"
          />
        </PopoverTrigger>
...
export default SimpleObjectiveTagManager;
